...
{-# LANGUAGE DeriveGeneric #-} -- used for making Temp Hashable
...
import GHC.Generics (Generic)  -- required for making Temp Hashable
import Data.Hashable           -- required for making Temp Hashable
...
data Temp = NamedTemp String
          | Temp Int deriving (Eq, Ord, Generic)

instance Hashable Temp
